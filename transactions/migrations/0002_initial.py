...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FinancialTransactions'
        db.create_table(u'transactions_financialtransactions', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('account', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounting.Account'])),
            ('payment_method_code', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('item_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crm.Product'])),
            ('date', self.gf('django.db.models.fields.DateField')(default='2014-11-23')),
        ...
        db.send_create_signal(u'transactions', ['FinancialTransactions'])


    def backwards(self, orm):
        # Deleting model 'FinancialTransactions'
        db.delete_table(u'transactions_financialtransactions')
    ...
    models = {
        ...
        u'transactions.financialtransactions': {
            'Meta': {'object_name': 'FinancialTransactions'},
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': "'2014-11-23'"}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '300', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'item_id': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['crm.Product']"}),
            'payment_method_code': ('django.db.models.fields.CharField', [], {'max_length': '2'})
        }
    }
