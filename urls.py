...
from crm.views import login_user, UpdateUserProfile, ListCustomers, ListSuppliers, ListCurrencies, ListTaxes, \
...
from accounting.views import DeleteAccountingPeriod, EditAccountingPeriod, CreateAccountingPeriod, ListAccountingPeriod, CreateAccount,ListAccount,EditAccount,DeleteAccount,CreateBooking,ListBooking,EditBooking,DeleteBooking
...
urlpatterns = i18n_patterns("",
                            ...
                            url(r'^account/create/$', CreateAccount.as_view(), name='account_create'),
                            url(r'^account/list/$', ListAccount.as_view(), name='account_list'),
                            url(r'account/edit/(?P<pk>\d+)/$',EditAccount.as_view(),name='account_edit'),
                            url(r'account/delete/(?P<pk>\d+)/$',DeleteAccount.as_view(),name='account_delete'),

                            url(r'^sales/create/$', CreateSale.as_view(), name='sale_create'),
                            url(r'^sales/list/$', ListSales.as_view(), name='sale_list'),
                            url(r'sales/edit/(?P<pk>\d+)/$',EditSale.as_view(),name='sale_edit'),
                            url(r'sales/delete/(?P<pk>\d+)/$',DeleteSale.as_view(),name='sale_delete'),
                            url(r'booking/create/$',CreateBooking.as_view(),name='booking_create'),
                            url(r'booking/list/$',ListBooking.as_view(),name='booking_list'),
                            url(r'booking/edit/(?P<pk>\d+)/$',EditBooking.as_view(),name='booking_edit'),
                            url(r'booking/detail/$',ListBooking.as_view(),name='booking_detail'),

                            url(r'booking/delete/(?P<pk>\d+)/$',DeleteBooking.as_view(),name='booking_delete'),

                            (r'^reporting/', include('model_report.urls')),#CustomersReport.as_view(),name='customers_list'),
...
#                           (r'^reports/', include('model_report.urls')),#CustomersReport.as_view(),name='customers_list'),
