...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Sale.tota_amount'
        db.delete_column(u'sales_sale', 'tota_amount')

        # Adding field 'Sale.total_amount'
        db.add_column(u'sales_sale', 'total_amount',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0.0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Sale.tota_amount'
        db.add_column(u'sales_sale', 'tota_amount',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0.0),
                      keep_default=False)

        # Deleting field 'Sale.total_amount'
        db.delete_column(u'sales_sale', 'total_amount')
    ...
    models = {
        ...
        u'sales.sale': {
            ...
            'total_amount': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0.0'})
        }
    }
