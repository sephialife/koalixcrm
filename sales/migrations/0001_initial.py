...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'sales_sale', (
            ...
            ('subtotal_amount', self.gf('django.db.models.fields.PositiveIntegerField')(default=0.0)),
            ('shipping_fee', self.gf('django.db.models.fields.FloatField')(default=0.0)),
            ('additional_fees', self.gf('django.db.models.fields.FloatField')(default=0.0)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True)),
            ('tota_amount', self.gf('django.db.models.fields.PositiveIntegerField')(default=0.0)),
        ))
    ...
    models = {
        ...
        u'sales.sale': {
            ...
            'shipping_fee': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
